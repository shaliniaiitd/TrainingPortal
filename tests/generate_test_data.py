...
class TestDataGenerator:
    ...
    @staticmethod
    def generate_excel(output_path: str = "tests/test_data/test_data.xlsx"):
    ...
    @staticmethod
    def generate_json(output_path: str = "tests/test_data/test_data.json"):
    ...
    @staticmethod
    def generate_database(db_url: str = "sqlite:///tests/test_data/test_data.db"):
